...
ventana_principal.title("VIDEO JUEGO")
ventana_principal.geometry("600x510")
ventana_principal.resizable(False, False)
ventana_principal.config(bg="white")

frame1 = Frame(ventana_principal)
frame1.config(width=580, height=350, bg="dark slate blue")
frame1.place(x=10, y=10)

frame2 = Frame(ventana_principal)
frame2.config(width=580, height=130, bg="dark slate blue")
...
imagen = PhotoImage(file="OVNI.png")
